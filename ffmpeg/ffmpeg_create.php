<?php
	...
	$output = getcwd() . "/video/" . $movie . "/" . urldecode($_GET["time"]) . $output_end . ".mp4";
	...
	echo "<br><video id='videoPlayer' src='video/" . $_GET["movie"] . "/" . $_GET["time"] . $output_end . ".mp4'  controls></video><br>\n";
	echo "</center>\n";
	echo "<pre>$output</pre>\n";
